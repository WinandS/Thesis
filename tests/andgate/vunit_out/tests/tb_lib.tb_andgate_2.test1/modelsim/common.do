...
proc vunit_load {{vsim_extra_args ""}} {
    set vsim_failed [catch {
        eval vsim ${vsim_extra_args} {-wlf {/home/winand/Documents/Google\ Drive/Schoolwerk/Masterproef/Thesis/tests/andgate/vunit_out/tests/tb_lib.tb_andgate_2.test1/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_andgate_2/runner_cfg={"enabled_test_cases : test1,output path : /home/winand/Documents/Google Drive/Schoolwerk/Masterproef/Thesis/tests/andgate/vunit_out/tests/tb_lib.tb_andgate_2.test1/,active python runner : true"} tb_lib.tb_andgate_2(tb_2)   -L vunit_lib -L desc_lib -L tb_lib}
    }]
    if {${vsim_failed}} {
       echo Command 'vsim ${vsim_extra_args} -wlf {/home/winand/Documents/Google\ Drive/Schoolwerk/Masterproef/Thesis/tests/andgate/vunit_out/tests/tb_lib.tb_andgate_2.test1/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_andgate_2/runner_cfg={"enabled_test_cases : test1,output path : /home/winand/Documents/Google Drive/Schoolwerk/Masterproef/Thesis/tests/andgate/vunit_out/tests/tb_lib.tb_andgate_2.test1/,active python runner : true"} tb_lib.tb_andgate_2(tb_2)   -L vunit_lib -L desc_lib -L tb_lib' failed
