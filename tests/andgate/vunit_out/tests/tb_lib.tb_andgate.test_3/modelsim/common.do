...
proc vunit_load {{vsim_extra_args ""}} {
    set vsim_failed [catch {
        eval vsim ${vsim_extra_args} {-wlf {/home/winand/Documents/Google\ Drive/Schoolwerk/Masterproef/Thesis/tests/andgate/vunit_out/tests/tb_lib.tb_andgate.test_3/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_andgate/runner_cfg={"enabled_test_cases : test_3,output path : /home/winand/Documents/Google Drive/Schoolwerk/Masterproef/Thesis/tests/andgate/vunit_out/tests/tb_lib.tb_andgate.test_3/,active python runner : true"} tb_lib.tb_andgate(tb)   -L vunit_lib -L desc_lib -L tb_lib}
    }]
    if {${vsim_failed}} {
       echo Command 'vsim ${vsim_extra_args} -wlf {/home/winand/Documents/Google\ Drive/Schoolwerk/Masterproef/Thesis/tests/andgate/vunit_out/tests/tb_lib.tb_andgate.test_3/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_andgate/runner_cfg={"enabled_test_cases : test_3,output path : /home/winand/Documents/Google Drive/Schoolwerk/Masterproef/Thesis/tests/andgate/vunit_out/tests/tb_lib.tb_andgate.test_3/,active python runner : true"} tb_lib.tb_andgate(tb)   -L vunit_lib -L desc_lib -L tb_lib' failed
