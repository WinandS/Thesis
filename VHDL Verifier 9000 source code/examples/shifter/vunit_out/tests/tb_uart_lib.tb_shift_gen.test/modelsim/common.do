...
proc vunit_load {{vsim_extra_args ""}} {
    set vsim_failed [catch {
        eval vsim ${vsim_extra_args} {-modelsimini /home/winand/Documents/Schoolwerk/Masterproef/Thesis/examples/shifter/vunit_out/modelsim/modelsim.ini -wlf {/home/winand/Documents/Schoolwerk/Masterproef/Thesis/examples/shifter/vunit_out/tests/tb_uart_lib.tb_shift_gen.test/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_shift_gen/runner_cfg={"enabled_test_cases : test,output path : /home/winand/Documents/Schoolwerk/Masterproef/Thesis/examples/shifter/vunit_out/tests/tb_uart_lib.tb_shift_gen.test/,active python runner : true"} tb_uart_lib.tb_shift_gen(shift_generated_testbench)   -L vunit_lib -L shifter_lib -L tb_uart_lib -L osvvm}
    }]
    if {${vsim_failed}} {
       echo Command 'vsim ${vsim_extra_args} -modelsimini /home/winand/Documents/Schoolwerk/Masterproef/Thesis/examples/shifter/vunit_out/modelsim/modelsim.ini -wlf {/home/winand/Documents/Schoolwerk/Masterproef/Thesis/examples/shifter/vunit_out/tests/tb_uart_lib.tb_shift_gen.test/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_shift_gen/runner_cfg={"enabled_test_cases : test,output path : /home/winand/Documents/Schoolwerk/Masterproef/Thesis/examples/shifter/vunit_out/tests/tb_uart_lib.tb_shift_gen.test/,active python runner : true"} tb_uart_lib.tb_shift_gen(shift_generated_testbench)   -L vunit_lib -L shifter_lib -L tb_uart_lib -L osvvm' failed
