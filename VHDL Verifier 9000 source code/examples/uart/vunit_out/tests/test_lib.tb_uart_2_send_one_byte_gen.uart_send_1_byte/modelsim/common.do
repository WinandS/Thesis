...
proc vunit_load {{vsim_extra_args ""}} {
    set vsim_failed [catch {
        eval vsim ${vsim_extra_args} {-modelsimini /home/winand/Documents/Schoolwerk/Masterproef/Thesis/examples/uart/vunit_out/modelsim/modelsim.ini -wlf {/home/winand/Documents/Schoolwerk/Masterproef/Thesis/examples/uart/vunit_out/tests/test_lib.tb_uart_2_send_one_byte_gen.uart_send_1_byte/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_uart_2_send_one_byte_gen/runner_cfg={"enabled_test_cases : uart_send_1_byte,output path : /home/winand/Documents/Schoolwerk/Masterproef/Thesis/examples/uart/vunit_out/tests/test_lib.tb_uart_2_send_one_byte_gen.uart_send_1_byte/,active python runner : true"} test_lib.tb_uart_2_send_one_byte_gen(uart_2_send_one_byte_generated_testbench)   -L test_lib -L vunit_lib -L osvvm -L src_lib}
    }]
    if {${vsim_failed}} {
       echo Command 'vsim ${vsim_extra_args} -modelsimini /home/winand/Documents/Schoolwerk/Masterproef/Thesis/examples/uart/vunit_out/modelsim/modelsim.ini -wlf {/home/winand/Documents/Schoolwerk/Masterproef/Thesis/examples/uart/vunit_out/tests/test_lib.tb_uart_2_send_one_byte_gen.uart_send_1_byte/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_uart_2_send_one_byte_gen/runner_cfg={"enabled_test_cases : uart_send_1_byte,output path : /home/winand/Documents/Schoolwerk/Masterproef/Thesis/examples/uart/vunit_out/tests/test_lib.tb_uart_2_send_one_byte_gen.uart_send_1_byte/,active python runner : true"} test_lib.tb_uart_2_send_one_byte_gen(uart_2_send_one_byte_generated_testbench)   -L test_lib -L vunit_lib -L osvvm -L src_lib' failed
