...
proc vunit_load {{vsim_extra_args ""}} {
    set vsim_failed [catch {
        eval vsim ${vsim_extra_args} {-modelsimini /home/winand/Documents/Schoolwerk/Masterproef/Thesis/examples/SPI/vunit_out/modelsim/modelsim.ini -wlf {/home/winand/Documents/Schoolwerk/Masterproef/Thesis/examples/SPI/vunit_out/tests/tb_uart_lib.tb_spi_gen.SPI_send_one_byte/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_spi_gen/runner_cfg={"enabled_test_cases : SPI_send_one_byte,output path : /home/winand/Documents/Schoolwerk/Masterproef/Thesis/examples/SPI/vunit_out/tests/tb_uart_lib.tb_spi_gen.SPI_send_one_byte/,active python runner : true"} tb_uart_lib.tb_spi_gen(spi_generated_testbench)   -L uart_lib -L vunit_lib -L tb_uart_lib}
    }]
    if {${vsim_failed}} {
       echo Command 'vsim ${vsim_extra_args} -modelsimini /home/winand/Documents/Schoolwerk/Masterproef/Thesis/examples/SPI/vunit_out/modelsim/modelsim.ini -wlf {/home/winand/Documents/Schoolwerk/Masterproef/Thesis/examples/SPI/vunit_out/tests/tb_uart_lib.tb_spi_gen.SPI_send_one_byte/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_spi_gen/runner_cfg={"enabled_test_cases : SPI_send_one_byte,output path : /home/winand/Documents/Schoolwerk/Masterproef/Thesis/examples/SPI/vunit_out/tests/tb_uart_lib.tb_spi_gen.SPI_send_one_byte/,active python runner : true"} tb_uart_lib.tb_spi_gen(spi_generated_testbench)   -L uart_lib -L vunit_lib -L tb_uart_lib' failed
