...
proc vunit_load {{vsim_extra_args ""}} {
    set vsim_failed [catch {
        eval vsim ${vsim_extra_args} {-modelsimini /home/winand/Documents/Schoolwerk/Masterproef/Thesis/examples/SPI/vunit_out/modelsim/modelsim.ini -wlf {/home/winand/Documents/Schoolwerk/Masterproef/Thesis/examples/SPI/vunit_out/tests/tb_spi_lib.tb_spi_gen.test/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_spi_gen/runner_cfg={"enabled_test_cases : test,output path : /home/winand/Documents/Schoolwerk/Masterproef/Thesis/examples/SPI/vunit_out/tests/tb_spi_lib.tb_spi_gen.test/,active python runner : true"} tb_spi_lib.tb_spi_gen(spi_generated_testbench)   -L vunit_lib -L spi_lib -L tb_spi_lib}
    }]
    if {${vsim_failed}} {
       echo Command 'vsim ${vsim_extra_args} -modelsimini /home/winand/Documents/Schoolwerk/Masterproef/Thesis/examples/SPI/vunit_out/modelsim/modelsim.ini -wlf {/home/winand/Documents/Schoolwerk/Masterproef/Thesis/examples/SPI/vunit_out/tests/tb_spi_lib.tb_spi_gen.test/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_spi_gen/runner_cfg={"enabled_test_cases : test,output path : /home/winand/Documents/Schoolwerk/Masterproef/Thesis/examples/SPI/vunit_out/tests/tb_spi_lib.tb_spi_gen.test/,active python runner : true"} tb_spi_lib.tb_spi_gen(spi_generated_testbench)   -L vunit_lib -L spi_lib -L tb_spi_lib' failed
