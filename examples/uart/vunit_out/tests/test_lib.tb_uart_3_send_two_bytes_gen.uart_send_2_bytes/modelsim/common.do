...
proc vunit_load {{vsim_extra_args ""}} {
    set vsim_failed [catch {
        eval vsim ${vsim_extra_args} {-modelsimini /home/winand/Documents/Schoolwerk/Masterproef/Thesis/examples/uart/vunit_out/modelsim/modelsim.ini -wlf {/home/winand/Documents/Schoolwerk/Masterproef/Thesis/examples/uart/vunit_out/tests/test_lib.tb_uart_3_send_two_bytes_gen.uart_send_2_bytes/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_uart_3_send_two_bytes_gen/runner_cfg={"enabled_test_cases : uart_send_2_bytes,output path : /home/winand/Documents/Schoolwerk/Masterproef/Thesis/examples/uart/vunit_out/tests/test_lib.tb_uart_3_send_two_bytes_gen.uart_send_2_bytes/,active python runner : true"} test_lib.tb_uart_3_send_two_bytes_gen(uart_3_send_two_bytes_generated_testbench)   -L test_lib -L vunit_lib -L osvvm -L src_lib}
    }]
    if {${vsim_failed}} {
       echo Command 'vsim ${vsim_extra_args} -modelsimini /home/winand/Documents/Schoolwerk/Masterproef/Thesis/examples/uart/vunit_out/modelsim/modelsim.ini -wlf {/home/winand/Documents/Schoolwerk/Masterproef/Thesis/examples/uart/vunit_out/tests/test_lib.tb_uart_3_send_two_bytes_gen.uart_send_2_bytes/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_uart_3_send_two_bytes_gen/runner_cfg={"enabled_test_cases : uart_send_2_bytes,output path : /home/winand/Documents/Schoolwerk/Masterproef/Thesis/examples/uart/vunit_out/tests/test_lib.tb_uart_3_send_two_bytes_gen.uart_send_2_bytes/,active python runner : true"} test_lib.tb_uart_3_send_two_bytes_gen(uart_3_send_two_bytes_generated_testbench)   -L test_lib -L vunit_lib -L osvvm -L src_lib' failed
