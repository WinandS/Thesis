...
proc vunit_load {{vsim_extra_args ""}} {
    set vsim_failed [catch {
        eval vsim ${vsim_extra_args} {-modelsimini /home/winand/Documents/Schoolwerk/Masterproef/Thesis/examples/andgate/vunit_out/modelsim/modelsim.ini -wlf {/home/winand/Documents/Schoolwerk/Masterproef/Thesis/examples/andgate/vunit_out/tests/test_lib.tb_andgatefull_failing_gen.andgate_failing/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_andgatefull_failing_gen/runner_cfg={"enabled_test_cases : andgate_failing,output path : /home/winand/Documents/Schoolwerk/Masterproef/Thesis/examples/andgate/vunit_out/tests/test_lib.tb_andgatefull_failing_gen.andgate_failing/,active python runner : true"} test_lib.tb_andgatefull_failing_gen(andgatefull_failing_generated_testbench)   -L test_lib -L vunit_lib -L osvvm -L src_lib}
    }]
    if {${vsim_failed}} {
       echo Command 'vsim ${vsim_extra_args} -modelsimini /home/winand/Documents/Schoolwerk/Masterproef/Thesis/examples/andgate/vunit_out/modelsim/modelsim.ini -wlf {/home/winand/Documents/Schoolwerk/Masterproef/Thesis/examples/andgate/vunit_out/tests/test_lib.tb_andgatefull_failing_gen.andgate_failing/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_andgatefull_failing_gen/runner_cfg={"enabled_test_cases : andgate_failing,output path : /home/winand/Documents/Schoolwerk/Masterproef/Thesis/examples/andgate/vunit_out/tests/test_lib.tb_andgatefull_failing_gen.andgate_failing/,active python runner : true"} test_lib.tb_andgatefull_failing_gen(andgatefull_failing_generated_testbench)   -L test_lib -L vunit_lib -L osvvm -L src_lib' failed
